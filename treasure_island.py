...
if choice == "left":
  choice = input('You came to a lake. There is an island in the middle of the lake. Type "wait to wait for a boat. Type "swim to swim across. ')
  if choice == "wait":
    ...
    if choice == "blue":
      ...
      print("You became lost. Game over.")
  else:
